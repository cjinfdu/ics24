...
- **[Sep 11, 2024]** [Gitlab](Gitlab) is released.
- **[Sep 11, 2024]** [ICS实验入门手册](ICS实验入门手册) is released.
- **[Sep 11, 2024]** Course Website is online.
...
| 02   | 09/11/2024 | 环境配置 & Gitlab              | [Lab0-Gitlab](Gitlab)                               |
---
```cpp
#include <stdio.h>
